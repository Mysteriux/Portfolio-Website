        ...
        <div className="md:flex">
            <div className="relative z-10">
                <motion.div
                    ...
                    className="py-2 relative z-20 md:flex h-full"
                >
                    <div className="w-[80%]">
                        <p className="mt-1 mb-8 text-sm md:text-lg text-gray-200">
                            with a strong background in C, C++, and JavaScript, and a passion for web development. My experience includes completing several projects that demonstrate my ability to create dynamic and responsive web applications.
                            
                        </p>
                        <p className="mt-1 mb-8 text-sm md:text-lg text-gray-200">
                            In addition to web development, I have a solid foundation in competitive programming and data structures and algorithms (DSA). I enjoy tackling complex problems and optimizing solutions, which has honed my analytical and coding skills.
                        </p>
                    </div>
